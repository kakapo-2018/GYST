...
class Bell extends React.Component {
  ...
  render() {
    ...
    var errorAlert = (
      <div className="alert alert-danger">Unsupported audio type</div>
    );
      ...
      <div className="bell">
        ...
        <div className="form">
          <div className="form-group form-inline">
            ...
            <button className={classes.btn} onClick={this.handlePlay}>
              <PlayArrow />
            </button>
            <button className={classes.btn} onClick={this.handleStop}>
              <Pause />
            </button>
          </div>
          <div className="form-group">
            ...
            <div className="form-group">
              <label htmlFor="local-sound" className="btn btn-default">
                Browse...
              </label>
              <input
                id="local-sound"
